...
public class JUser {
    ...
    public  JUser(Users new_user, Users old_user)
    {
        ...
        if (new_user==null)
        {
            ...
            userFields.add(new UserFields(UserFields.FieldName.BIRTHDAY,old_user.getBirthDate().toString(),""));
        ...
        }else if (old_user==null)
        {
            ...
            userFields.add(new UserFields(UserFields.FieldName.BIRTHDAY,"",new_user.getBirthDate().toString()));
        ...
        }else
        {
            ...
            if (old_user.getBirthDate()!=new_user.getBirthDate())
            {
                userFields.add(new UserFields(UserFields.FieldName.BIRTHDAY,old_user.getBirthDate().toString(),new_user.getBirthDate().toString()));
            }
        }
