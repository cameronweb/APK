package com.example.workcalendar.DataModel.SharedPreference;

import android.content.Context;
import android.content.SharedPreferences;
import android.os.Build;
import androidx.annotation.RequiresApi;
import com.example.workcalendar.DataModel.DAO.SettingsDAO;
...
public class SHPreferenceSettings implements SettingsDAO {
    ...
    public static final String WIFI_SYNC="WIFI_SINC";
    ...
    public boolean setWifiSync(boolean checked) {
        SharedPreferences.Editor editor=sharedPreferences.edit();
        editor.putBoolean(WIFI_SYNC,checked);
        return editor.commit();
    }

    @Override
    public boolean getWifiSync() {
        return sharedPreferences.getBoolean(WIFI_SYNC,false);
    }
}
