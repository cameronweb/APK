package com.example.workcalendar.ViewModel.RxJavaValidation;
...
public class RxTextEditor {
                 ...
                 calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
                     ...
                     public void onSelectedDayChange(@NonNull CalendarView view, int year, int month, int dayOfMonth) {
                        ...
                        if (checkWorkDate(workDate)){
                           ...
                           if(!checExists(workDate))
                           {
                               result= new Pair<>(workDate,"");
                           }else
                           {
                               result= new Pair<>(workDate,"Дата дежурства уже установлена!");
                           }
    ...
    private static boolean checExists(Date date)
    {
        return GlobalApplication.workComponent().getDataModel().checkExists(date);
    }
}
